...
- [ ] 5. **Download this [repository](https://github.com/fleschutz/bulletproof-backups/archive/refs/tags/v0.2.zip)** (5.8MB), then unzip and copy it as top folder 📁*bulletproof-backups* onto each hard drive.
